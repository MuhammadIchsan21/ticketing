            ...
            <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <a href="{{route('checkout-remove', $detail->id) }}"><img
                                                    src="{{url('frontend/images/Ic_remove.png')}}" alt="" /></a>
                                        </td>
                                    </tr>
                                    @empty --}}
                                    {{-- <tr>
                ...
                <div class="col-lg-4">
                        ...
                        <table class="trip-informations">
                            ...
                            <tr>
                                ...
                                <td width="50%" class="text-right text-total">
                                    <span class="text-blue">,</span><span class="text-orange">{{ mt_rand(0,99) }}</span>
                                </td>
                            </tr>
                        </table>
                    ...
                    <div class="join-container">
                        <a href="#" class="btn btn-block btn-join-now mt-3 py-2">I Have Made
                            Payment</a>
                    </div>
